...
#Added import-csv function for large query
#Script looks for CSV file in C:\EXO, CSV has one column "PrimarySmtpAddress".  CSV location on line 211.
#SMTP address can be obtained using findonprem.ps1
...
#region fnLoad
    Function fnLoad {
        ...
        if (-not $Global:isConnected) {
            ...
            import-csv C:\exo\import.csv | foreach {Get-MailUser -id $_.primarysmtpaddress | Sort-Object Name | Where-Object {$_.ExchangeGuid -ne "00000000-0000-0000-0000-000000000000"}}| ForEach-Object {
